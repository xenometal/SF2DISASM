...
; Note: Constant names ("enums"), shorthands (defined by macro), and numerical indexes are interchangeable.
                ...
                baseMov  6
                baseResistance NONE
                baseProwess    CRITICAL125_1IN16|DOUBLE_1IN16|COUNTER_1IN8
                items &
                    FORCE_SWORD|EQUIPPED, &
                    NOTHING, &
                    NOTHING, &
                    NOTHING
                spells &
                ...
                baseMov  5
                baseResistance NONE
                baseProwess    CRITICAL125_1IN16|DOUBLE_1IN32|COUNTER_1IN8
                items &
                    GIANT_KNUCKLES|EQUIPPED, &
                    NOTHING, &
                    NOTHING, &
                    NOTHING
                spells &
                ...
                baseMov  7
                baseResistance NONE
                baseProwess    CRITICAL125_1IN16|DOUBLE_1IN32|COUNTER_1IN16
                items &
                    HOLY_LANCE|EQUIPPED, &
                    NOTHING, &
                    NOTHING, &
