...
;        Constant names ("enums"), shorthands (defined by macro), and numerical indexes are interchangeable.
                ...
                enemyBattleSprAndPlt ODD_EYE, 0 ; 0: Bowie?
                enemyBattleSprAndPlt CAMEELA, 0 ; 1: Sarah?
                enemyBattleSprAndPlt PEGASUS_KNIGHT, 0 ; 2: Chester?
                enemyBattleSprAndPlt RED_BARON, 0 ; 3: Jaha?
                enemyBattleSprAndPlt NECROMANCER, 0 ; 4: Kazin?
                enemyBattleSprAndPlt BOW_RIDER, 0 ; 5: May?
